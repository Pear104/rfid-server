...
let LecturerRepository = class LecturerRepository {
    constructor() {
    ...
    async findOne(id) {
        return (await (0, firestore_2.getDocs)((0, firestore_2.query)((0, firestore_2.collection)(this.db, 'lecturer'), (0, firestore_2.where)('id', '==', id)))).docs[0].data();
    }
    async findAll() {
        return (await (0, firestore_2.getDocs)((0, firestore_2.collection)(this.db, 'lecturer'))).docs.map((item) => item.data());
    }
    async create(data) {
        try {
            await (0, firestore_2.addDoc)((0, firestore_2.collection)(this.db, 'lecturer'), data);
            return {
